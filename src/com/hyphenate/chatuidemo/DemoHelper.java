...
import com.hyphenate.chatuidemo.im.UserApiModel;
import com.hyphenate.chatuidemo.im.UserInfoCacheSvc;
...
public class DemoHelper {
	...
	private EaseUser getUserInfo(String username){
        ...
        UserApiModel userInfo = UserInfoCacheSvc.getById(username);
        if (userInfo != null){
            user = new EaseUser(username);
            user.setAvatar(userInfo.getHeadImg());
            user.setNick(userInfo.getEaseMobUserName());
        }
        return user;
	}
