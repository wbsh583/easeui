...
import com.hyphenate.chatuidemo.im.SharePrefConstant;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper{
    public static void setiLoginData(ILoginData iLoginData) {
        ChatFragment.iLoginData = iLoginData;
    }

    public  static ILoginData iLoginData;
    ...
    private void setUserInfoAttribute(EMMessage message) {
        try {
            if (iLoginData != null) {
                message.setAttribute(SharePrefConstant.ChatUserId, iLoginData.getUserId());
                message.setAttribute(SharePrefConstant.ChatUserNick, iLoginData.getUserName());
                message.setAttribute(SharePrefConstant.ChatUserPic, iLoginData.getAvatar()) ;//这里用是图片的完整链接地址，如果要取缩略图，需要服务端配合；
            }
